...
function SmartStudyAssistant() {
  ...
  function handleAddToFocus(task) {
    ...
    if (result.added) {
      setFeedback(`„${task.title}“ je dodat u današnji fokus.`)
      return
    }

    if (result.reason === 'exists') {
      setFeedback('Ta obaveza je već u današnjem fokusu.')
      return
    }
    ...
    <section className="smart-study-assistant">
      <div className="smart-study-heading">
        <div>
          ...
          <p>
            EduFlow rangira obaveze prema roku, prioritetu i trenutnom opterećenju.
          </p>
        </div>
        ...
        <section className="smart-study-recommendations">
          ...
          {recommendations.length > 0 ? (
            ...
            <div className="smart-study-empty">
              ...
              <p>
                Završi planirane obaveze ili dodaj novu obavezu u planer.
              </p>
            </div>
          )}
        </section>
