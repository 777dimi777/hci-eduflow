...
export function TaskProvider({ children }) {
  ...
  function addExamTask({
    ...
    const examDetails = [
      ...
      scheduleEntry.duration ? `Trajanje: ${scheduleEntry.duration}` : "",
  ...
  function updateExamTaskSubject({ scheduleId, scheduleEntryId, subjectId }) {
    setTasks((previousTasks) =>
      previousTasks.map((task) => {
        const belongsToSchedule =
          String(task.sourceScheduleId) === String(scheduleId) &&
          String(task.sourceScheduleEntryId) === String(scheduleEntryId);
